---
title: "Project Draft"
author: 'Lilly Clark, Thea Dowrich and Daisy Fang'
date: "4/15/2020"
...
```{r medicaid-changes, echo = FALSE, warning = FALSE}
medicaid <- read_csv("data/Medicaid Spending_clean.csv")
...
ggplot(data = medicaid, mapping = aes(x = spending, y = enrollment, colour = State)) +
  ...
  scale_x_log10() +
  scale_y_continuous(limits = c(25, 12000))
  facet_wrap(~Region, ncol = 4) +
  theme_light(base_size = 11) +
  labs(title = 'Year: {frame_time}', x = 'Spending (in Millions of Dollars)', y = 'Medicaid Enrollee Population (Thousands)') +
