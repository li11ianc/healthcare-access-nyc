...
<img src="Project-Draft_files/figure-html/medicaid-changes, -1.gif" style="display: block; margin: auto;" />
...
While the West North Central States have the highest beds per 1000 people, Washington, California and New York where the pandemic has hit the hardest have low ratio in comparison. While the healthcare system might have a lower cpacity, New York has almost all government or non-profit hospitals which is the highest proportion in the country. These types of hospitals providing relatively more affortable treatments than for-profit hospitals.

Zooming into the New York Metropolitan Area, the lack of timeliness in hospital care adds a hurdle to treating patients of the pandemic. Medicare hospitals was on part with the national average in terms of treatment effectiveness and even a lower mortality rate. However, they rank very low for timeliness of care. readmission and patient experience. The struggles with timeliness is extremely concerning as patients with severe symptoms of COVID-19 are in dire need of immediate care. This could be an explanation for the overloading of the healthcare system in the area.

Finally, the progress of policies still has a long way to go in making healthcare accessible to the particular volunerable low-income population of New York residents. While the state's Medicaid enrollment has been increasing at a fater and faster rate over the past few decades, the increase in spending on the program has been plateaued since 2010. Takin into account of inflation as well as the increasing enrollee population, there is great concern in how effective the Medicaid program expansion has been.

The stress and uncertainty brough by the coronavirus has been a wake up call for many of us, and especially the US healthcare system. It reveals much of the disproportional negative impact on populations with low socioeconomic status, pre-existing health conditions and old age. This analysis has illustrated that the rapid spread of the virus in the NY Metropolitan Area is not only a result of the dense-population but also that of a lacking healthcare system. We can only hope that stakeholders will reflect on and assess reaction to the pandemic to inform future decision and policy making to create a more equitable and effectives healthcare system. 
